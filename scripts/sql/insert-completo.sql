-- Script completo para inserir todas as 248 defensorias
-- Este script inclui regionais, unidades e defensorias
...
INSERT INTO unidades (nome, endereco, telefone, regional_id, coordenador, email_coordenador, supervisor, email_supervisor) VALUES
('CAMPO GRANDE | CENTRO/NUFAMD', 'Rua Antônio Maria Coelho, 1668 - Centro - CEP: 79002-220', '(67) 3317-8757', (SELECT id FROM regionais WHERE numero = 1 LIMIT 1), 'Danilo Hamano Silveira Campos', 'daniloh@defensoria.ms.def.br', 'Anna Cláudia Rodrigues Santos', 'annac@defensoria.ms.def.br');

-- CAMPO GRANDE | FÓRUM/NUCRIM
INSERT INTO unidades (nome, endereco, telefone, regional_id, coordenador, email_coordenador, supervisor, email_supervisor) VALUES
('CAMPO GRANDE | FÓRUM/NUCRIM', 'Rua da Paz, 14 - Jardim dos Estados - CEP: 79002-919', '(67) 3317-4300', (SELECT id FROM regionais WHERE numero = 1 LIMIT 1), 'Francianny Cristine da Silva Santos', 'franciannyc@defensoria.ms.def.br', 'Helton Campos da Costa', 'heltonc@defensoria.ms.def.br');
